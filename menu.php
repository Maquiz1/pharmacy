...
<div class="menu">
    ...
    <ul class="navigation">
        ...
        <?php if ($user->data()->accessLevel == 1) { ?>
            ...
            <li class="openable">
                <a href="#"><span class="isw-archive"></span><span class="text">Details</span></a>
                <ul>
                    <li>
                        <a href="add.php?id=4">
                            <span class="glyphicon glyphicon-plus"></span><span class="text">Add Details</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a href="add.php?id=7">
            ...
            <li class="openable">
                <a href="#"><span class="isw-folder"></span><span class="text">Dispense / Use</span></a>
                <ul>
                    <li>
                        <a href="add.php?id=8">
                            <span class="glyphicon glyphicon-plus"></span><span class="text">dispense / Use</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="openable">
                ...
                <ul>
                    <li>
                        ...
                        <a href="add.php?id=6">
                            <span class="glyphicon glyphicon-home"></span><span class="text">Add Medicine / Device Category</span>
                        </a>
                        <a href="add.php?id=9">
                            <span class="glyphicon glyphicon-home"></span><span class="text">Add Device / Medicine Groups</span>
                        </a>
            ...
            <li class="openable">
                <a href="#"><span class="isw-lock"></span><span class="text">Items</span></a>
                <ul>
                    <li>
                        <a href="info.php?id=15">
                            <span class="text">Group</span> <span class="badge badge-primary badge-pill"><?= $override->getNo('use_group') ?></span>

                        </a>
                    </li>
                    <li>
                        <a href="info.php?id=11">
                            <span class="text">Use Case</span> <span class="badge badge-primary badge-pill"><span class="number"><?= $override->getNo('use_case') ?></span></span>

                        </a>
                    </li>
                    <li>
                        <a href="info.php?id=13">
                            <span class="text">Location</span> <span class="badge badge-primary badge-pill"><?= $override->getNo('location') ?></span>

                        </a>
                    </li>
                    <li>
                        <a href="info.php?id=17">
                            <span class="text">Stocks Guide</span> <span class="badge badge-primary badge-pill"><?= $override->getCount('batch_description', 'status', 1) ?></span>
